...
export const metadata: Metadata = {
  ...
  description:
    "Complete taxi services in Haryana — local cab, airport transfer, outstation taxi, one-way, round trip, corporate cab, wedding car, and Tempo Traveller. Book now!",
};
