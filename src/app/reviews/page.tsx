...
export const metadata: Metadata = {
  ...
  description:
    "Read genuine customer reviews of Haryana Taxi Service. 4.8 star rated taxi service across Haryana and Delhi NCR. 500+ happy customers.",
};
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 to-gray-800 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg">
            Genuine reviews from thousands of satisfied customers across Haryana &amp; Delhi NCR
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-yellow-400">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <a
            href="https://wa.me/919876543210?text=Hi! I want to share my review for Haryana Taxi Service"
            target="_blank"
