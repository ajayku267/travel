...
export async function generateMetadata() {
  ...
  return {
    title: `Terms of Service - ${settings.companyName}`,
    description: `Terms and conditions for booking taxis with ${settings.companyName}.`,
  };
}
    ...
    <div className="min-h-screen bg-gray-50 pt-32 pb-20">
      <div className="max-w-3xl mx-auto px-5">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 space-y-6 text-gray-600">
          <p>
            Welcome to {settings.companyName}. By booking a taxi with us, you agree to the following terms and conditions.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>Passengers are responsible for their own belongings. {settings.companyName} is not liable for lost items.</li>
