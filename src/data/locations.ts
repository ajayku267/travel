...
export const locations: Location[] = [
  {
    ...
    highlights: [
      "24/7 taxi service from Dadri",
      "Largest fleet in Charkhi Dadri district",
      "Pick-up from any location in Dadri",
      "Background verified professional drivers",
      "Fixed fares — no hidden charges",
      "AC and Non-AC vehicles available",
    ],
    faqs: [
      {
    ...
    keywords: [
      "taxi service in charkhi dadri",
      "cab service dadri",
      "charkhi dadri taxi booking",
      "dadri to delhi taxi",
    ],
  },
  {
    ...
    services: [
      ...
      "Outstation Cab from Bhiwani",
      "Airport Transfer from Bhiwani",
      "Corporate Cab Service",
      "One Way Taxi",
      "Round Trip Cab",
    ],
    highlights: [
      "Trusted taxi service since 2010",
      "Pick-up from any location in Bhiwani",
    ...
    keywords: [
      ...
      "bhiwani cab service",
      "bhiwani taxi booking",
      "bhiwani to delhi taxi",
    ],
  },
  {
    id: "3",
    ...
    highlights: [
      "Closest major city to Delhi — quick service",
      "Regular cabs for daily commuters",
      "Student-friendly pricing",
      "All pickup points in Rohtak",
  ...
  },
  {
    ...
    highlights: [
      "Corporate taxi specialists",
      "IGI Airport in 30 minutes",
      "All sectors of Gurgaon covered",
      "Monthly billing for corporates",
      "24/7 executive cab service",
