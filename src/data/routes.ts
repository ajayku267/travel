...
export const routes: Route[] = [
  {
    ...
    faqs: [
      {
        question: "How long does it take to travel from Dadri to Delhi?",
        answer:
          "The journey typically takes 2.5 to 3 hours depending on traffic conditions. NH-9 is the most common route taken.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, we offer both one-way and round-trip taxis from Dadri to Delhi at competitive rates.",
      },
      {
    ...
    keywords: [
      "dadri to delhi taxi",
      "charkhi dadri to delhi cab",
      "dadri delhi cab booking",
      "taxi from dadri to delhi",
    ],
  },
  {
    id: "2",
    ...
    highlights: [
      "Corporate cab service available",
      "Airport transfer to IGI Airport via Gurgaon",
      "Drop to any sector in Gurgaon",
      "Fixed meter-free pricing",
      "On-time pick-up guarantee",
      "GST invoice provided",
    ],
    faqs: [
      {
        question: "How far is Gurgaon from Charkhi Dadri?",
        answer:
          "Gurgaon is approximately 105 km from Charkhi Dadri via NH-9 and NH-48. The drive takes about 2 to 2.5 hours.",
      },
      {
        question: "Do you offer corporate taxi service from Dadri to Gurgaon?",
        answer:
          "Yes, we provide corporate cab service with GST invoices. We also offer monthly cab packages for regular commuters.",
      },
      {
        question: "Can your cab continue to IGI Airport from Gurgaon?",
        answer:
    ...
    keywords: [
      ...
      "charkhi dadri to gurugram cab",
      "dadri gurgaon taxi booking",
    ],
  },
  {
    id: "3",
    ...
    highlights: [
      ...
      "Stop for meals and breaks allowed",
      "Drop anywhere in Chandigarh / Mohali / Panchkula",
      "Return journey booking discount available",
    ],
    faqs: [
      {
        question: "What is the distance from Dadri to Chandigarh?",
        answer:
          "The distance is approximately 210 km via NH-9 and NH-44. Travel time is 4 to 5 hours.",
      },
      {
        question: "Are tolls included in the taxi fare?",
        answer:
          "Toll charges are included in our quoted fare. There are no surprise extra charges.",
      },
      {
        question: "Can I hire a cab for Chandigarh to Dadri return trip?",
        answer:
    ...
    keywords: [
      "dadri to chandigarh taxi",
      "charkhi dadri chandigarh cab",
      "outstation taxi dadri chandigarh",
    ],
  },
  {
    id: "4",
    ...
    highlights: [
      "24/7 cab service from Bhiwani",
      "Airport transfers to IGI Airport",
      "Railway station transfers",
      "Corporate booking with invoice",
      "Real-time driver tracking",
      "Professional and background-verified drivers",
    ],
    faqs: [
      {
        question: "How long is the drive from Bhiwani to Delhi?",
        answer:
          "The drive takes approximately 2.5 to 3.5 hours depending on traffic. We recommend early morning travel to avoid rush-hour delays.",
      },
      {
        question: "Can I get a taxi from Bhiwani at midnight?",
        answer:
          "Yes, we offer 24/7 cab service including late night and early morning pickups from Bhiwani.",
      },
      {
        question: "Do you provide airport transfer from Bhiwani to IGI Airport?",
        answer:
  ...
  },
  {
    ...
    highlights: [
      "Business class travel available",
      "Corporate monthly packages",
      "DLF, Cyber City, MG Road drop",
      "Fixed fare — no surge pricing",
      "WiFi on select premium vehicles",
      "Experienced highway drivers",
    ],
    faqs: [
      {
        question: "What is the distance from Hisar to Gurgaon?",
        answer:
          "Hisar to Gurgaon is approximately 175 km via NH-52 and NH-48. The journey takes 3 to 4 hours.",
      },
      {
        question: "Is there a direct highway from Hisar to Gurgaon?",
        answer:
          "Yes, NH-52 (Hisar to Rohtak) connects to NH-48 (Delhi–Jaipur Expressway) which leads directly to Gurgaon.",
      },
      {
        question: "Can I book a corporate monthly cab from Hisar to Gurgaon?",
        answer:
    ...
    keywords: [
      "hisar to gurgaon taxi",
      "hisar gurgaon cab",
      "taxi from hisar to gurgaon",
      "hisar to gurugram cab",
    ],
  },
  {
    id: "6",
    ...
    highlights: [
      "Shortest route via NH-9",
      "Multiple vehicle options",
      "Frequent departures",
      "Early morning flight-catcher service",
      "Sharing and private options",
      "Student discount available",
    ],
    faqs: [
      {
        question: "How far is Delhi from Rohtak?",
        answer: "Delhi is approximately 80 km from Rohtak via NH-9. Travel time is 1.5 to 2 hours.",
      },
      {
...
export const popularRoutes = routes.slice(0, 5);
